...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav className="bg-[#009AE4] text-white shadow-md px-4 py-3 flex items-center justify-between fixed top-0 left-0 w-full z-50 transition-all duration-300">
